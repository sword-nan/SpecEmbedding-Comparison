...
def embedding(
    ...
    spectra = np.load(Path(mgf_path).with_suffix(".npy"), allow_pickle=True)
    embedding_vector = dreams_embeddings(mgf_path, batch_size=128, progress_bar=show_progress_bar)
    return spectra, embedding_vector
...
def search_with_embedding(
    desc: str, k_metric: list[int], 
    query_embedding: npt.NDArray, ref_embedding: npt.NDArray,
    query_smiles: Sequence[str], ref_smiles: Sequence[str],
