...
from msml.models.layers.fourier_features import FourierFeatures
from msml.models.layers.feed_forward import FeedForward
import msml.utils.spectra as su
import msml.utils.data as du
from msml.definitions import NIST20, MONA
from msml.models.optimization.schedulers import NoamScheduler
from msml.models.dreams.layers import TransformerEncoder
from msml.models.optimization.losses_metrics import FocalLoss
...
class DreaMS(pl.LightningModule):
    ...
    def __init__(self, args, spec_preproc: du.SpectrumPreprocessor):
        """
        Argument and their dependencies are validated in msml/experiments/pre_training/train_arparse.py.
        """
